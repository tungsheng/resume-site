...
describe("ExperimentsPage", () => {
  ...
  test("renders experiment-specific detail content", () => {
    ...
    expect(html).toContain("Queueing sets the boundary");
    expect(html).toContain("Latest reports: 2026-05-18 UTC");
    expect(html).toContain("Server timing shows admission removes queue and TTFT inflation");
    expect(html).toContain("Stable repeat");
    expect(html).toContain("1.10 req/s");
    expect(html).toContain("Queue starts");
    expect(html).toContain("1.15 req/s");
    expect(html).toContain("Queue dominated");
    expect(html).toContain("100% delivered; p95 63.40s; p95 queue 36.93s");
    expect(html).toContain("Cap variants");
    expect(html).toContain("0 wins");
    expect(html).toContain("Admission result");
    expect(html).toContain("59 unserved; p95 queue 0.285s; 32 active");
    expect(html).toContain("8192/300 rate sweep");
    expect(html).toContain("Server timing attribution");
    ...
    expect(html).toContain("25.23s");
    expect(html).toContain("42.49s");
    expect(html).toContain("63.40s");
    expect(html).toContain("77.51s");
    expect(html).toContain("36.93s / 37.61s");
